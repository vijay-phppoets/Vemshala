...
import { Button, Space, Divider, Spin, message } from "antd"
import {
    ShoppingCartOutlined, FacebookOutlined, TwitterOutlined, InstagramOutlined, HeartFilled,
    HeartOutlined
...
import {
    Price, RegulerPrice, ShortDescription, CartButton, Label, Left, Right,
    DesktopImgContainer, MobileImgContainer, RelatedProductWrapper,
    RelatedProductBox, AddInfoTbl, WishlistButton, ProductCollapse, ProductPanel,
    ColorBox, SwatchBtn, OutOfStock
...
import { getCartId, setCartId, inr, getToken, getCustomer, getCurrency } from "../../utils"
